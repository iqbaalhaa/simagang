    ...
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <div class="login-form">
                ...
                <form action="<?= base_url('Auth/prosesResetPassword') ?>" method="POST">
                    <input type="hidden" name="token" value="<?= $token ?>">
                    <div class="form-group form-floating-label">
                        <input id="password" name="password" type="password" class="form-control input-border-bottom" required minlength="6">
                        <label for="password" class="placeholder">Password Baru</label>
                    </div>
                    <div class="form-group form-floating-label">
                        <input id="confirm_password" name="confirm_password" type="password" class="form-control input-border-bottom" required minlength="6">
                        <label for="confirm_password" class="placeholder">Konfirmasi Password</label>
                    </div>
