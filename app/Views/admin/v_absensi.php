        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Pilih Kelompok Magang</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $k['nama_ketua'] ?></td>
                                    <td>
                                        <span class="badge badge-<?= $k['status'] == 'disetujui' ? 'success' : 
                                            ($k['status'] == 'ditolak' ? 'danger' : 'warning') ?>">
                                            <?= ucfirst($k['status']) ?>
                                        </span>
                                    </td>
                                    <td>
...
function lihatAbsensi(id_pengajuan) {
    $.ajax({
        url: '<?= base_url('Admin/getAbsensiKelompok') ?>/' + id_pengajuan,
        type: 'GET',
